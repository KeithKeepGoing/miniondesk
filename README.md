...
| 🏭 **IC 設計專屬** | HPC Job 查詢、EDA License、Log 分析、RTL DLP |
| 🏢 **企業功能** | 知識庫 RAG、審批流程、RBAC、AD/LDAP、Jira、GitLab |
| 🌐 **Web Portal** | 瀏覽器對話介面，支援大型 Log / Code 貼上 |
| 💾 **完全自架** | SQLite + Docker，資料不出公司 |
| 📱 **多平台** | Telegram / Discord / Microsoft Teams / Web |
